...
func (x *PaymentIntentUpdateRequest_FundsReceived) GetPaymentAmount() *common.Decimal {
	if x != nil {
...
func (x *PaymentIntentUpdateRequest_FundsReceived) GetPaymentMethod() common.PaymentMethodType {
	if x != nil {
...
func (x *PaymentIntentUpdateRequest_FundsReceived) GetTransactionReference() string {
	if x != nil {
