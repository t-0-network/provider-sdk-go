...
import (
	...
	context "context"
	errors "errors"
	public "github.com/t-0-network/provider-sdk-go/api/gen/proto/tzero/v1/public"
	http "net/http"
	strings "strings"
)
...
const (
	...
	PaymentServiceName = "tzero.v1.public.PaymentService"
	// UserServiceName is the fully-qualified name of the UserService service.
	UserServiceName = "tzero.v1.public.UserService"
)
...
const (
	...
	// GetPaymentQuote RPC.
	PaymentServiceGetPaymentQuoteProcedure = "/tzero.v1.public.PaymentService/GetPaymentQuote"
	// PaymentServiceCreatePaymentIntentProcedure is the fully-qualified name of the PaymentService's
	// CreatePaymentIntent RPC.
	PaymentServiceCreatePaymentIntentProcedure = "/tzero.v1.public.PaymentService/CreatePaymentIntent"
	// PaymentServiceGetPayInDetailsProcedure is the fully-qualified name of the PaymentService's
	// GetPayInDetails RPC.
	PaymentServiceGetPayInDetailsProcedure = "/tzero.v1.public.PaymentService/GetPayInDetails"
	// PaymentServiceGetPaymentsProcedure is the fully-qualified name of the PaymentService's
	// GetPayments RPC.
	PaymentServiceGetPaymentsProcedure = "/tzero.v1.public.PaymentService/GetPayments"
	// UserServiceGetCurrentUserProcedure is the fully-qualified name of the UserService's
	// GetCurrentUser RPC.
	UserServiceGetCurrentUserProcedure = "/tzero.v1.public.UserService/GetCurrentUser"
)

// PaymentServiceClient is a client for the tzero.v1.public.PaymentService service.
...
// NewPaymentServiceClient constructs a client for the tzero.v1.public.PaymentService service. By
...
func NewPaymentServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PaymentServiceClient {
	...
	paymentServiceMethods := public.File_tzero_v1_public_public_proto.Services().ByName("PaymentService").Methods()
...
// GetPaymentQuote calls tzero.v1.public.PaymentService.GetPaymentQuote.
...
// CreatePaymentIntent calls tzero.v1.public.PaymentService.CreatePaymentIntent.
...
// GetPayInDetails calls tzero.v1.public.PaymentService.GetPayInDetails.
...
// GetPayments calls tzero.v1.public.PaymentService.GetPayments.
...
// PaymentServiceHandler is an implementation of the tzero.v1.public.PaymentService service.
...
func NewPaymentServiceHandler(svc PaymentServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/tzero.v1.public.PaymentService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPaymentServiceHandler) GetPaymentQuote(context.Context, *connect.Request[public.GetPaymentQuoteRequest]) (*connect.Response[public.GetPaymentQuoteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tzero.v1.public.PaymentService.GetPaymentQuote is not implemented"))
}
...
func (UnimplementedPaymentServiceHandler) CreatePaymentIntent(context.Context, *connect.Request[public.CreatePaymentIntentRequest]) (*connect.Response[public.CreatePaymentIntentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tzero.v1.public.PaymentService.CreatePaymentIntent is not implemented"))
}
...
func (UnimplementedPaymentServiceHandler) GetPayInDetails(context.Context, *connect.Request[public.GetPayInDetailsRequest]) (*connect.Response[public.GetPayInDetailsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tzero.v1.public.PaymentService.GetPayInDetails is not implemented"))
}
...
func (UnimplementedPaymentServiceHandler) GetPayments(context.Context, *connect.Request[public.GetPaymentsRequest]) (*connect.Response[public.GetPaymentsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tzero.v1.public.PaymentService.GetPayments is not implemented"))
}

// UserServiceClient is a client for the tzero.v1.public.UserService service.
...
// NewUserServiceClient constructs a client for the tzero.v1.public.UserService service. By default,
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	userServiceMethods := public.File_tzero_v1_public_public_proto.Services().ByName("UserService").Methods()
...
// GetCurrentUser calls tzero.v1.public.UserService.GetCurrentUser.
...
// UserServiceHandler is an implementation of the tzero.v1.public.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/tzero.v1.public.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) GetCurrentUser(context.Context, *connect.Request[public.GetCurrentUserRequest]) (*connect.Response[public.GetCurrentUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tzero.v1.public.UserService.GetCurrentUser is not implemented"))
}
