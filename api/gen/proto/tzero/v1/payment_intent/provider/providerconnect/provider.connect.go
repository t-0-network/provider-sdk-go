...
import (
	...
	context "context"
	errors "errors"
	provider "github.com/t-0-network/provider-sdk-go/api/gen/proto/tzero/v1/payment_intent/provider"
	http "net/http"
	strings "strings"
)
...
func NewNetworkServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) NetworkServiceClient {
	...
	networkServiceMethods := provider.File_tzero_v1_payment_intent_provider_provider_proto.Services().ByName("NetworkService").Methods()
...
func NewProviderServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProviderServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	providerServiceMethods := provider.File_tzero_v1_payment_intent_provider_provider_proto.Services().ByName("ProviderService").Methods()
