...
func (PaymentMethodType) Descriptor() protoreflect.EnumDescriptor {
	return file_common_payment_method_proto_enumTypes[0].Descriptor()
}

func (PaymentMethodType) Type() protoreflect.EnumType {
	return &file_common_payment_method_proto_enumTypes[0]
}
...
func (x *SwiftPaymentMethod) Reset() {
	*x = SwiftPaymentMethod{}
	mi := &file_common_payment_method_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SwiftPaymentMethod) Descriptor() ([]byte, []int) {
	return file_common_payment_method_proto_rawDescGZIP(), []int{2}
}
...
func (x *StablecoinPaymentMethod) Reset() {
	*x = StablecoinPaymentMethod{}
	mi := &file_common_payment_method_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StablecoinPaymentMethod) Descriptor() ([]byte, []int) {
	return file_common_payment_method_proto_rawDescGZIP(), []int{3}
}
...
const file_common_payment_method_proto_rawDesc = "" +
	"\n" +
	"\x1bcommon/payment_method.proto\x12\x0ftzero.v1.common\x1a\x13common/common.proto\"\xdd\x01\n" +
	"\rPaymentMethod\x128\n" +
	"\x04sepa\x18\n" +
	...
	"\x18PAYMENT_METHOD_TYPE_CARD\x10\x1eB\xc4\x01\n" +
	"\x13com.tzero.v1.commonB\x12PaymentMethodProtoP\x01Z;github.com/t-0-network/provider-sdk-go/api/gen/proto/common\xa2\x02\x03TVC\xaa\x02\x0fTzero.V1.Common\xca\x02\x0fTzero\\V1\\Common\xe2\x02\x1bTzero\\V1\\Common\\GPBMetadata\xea\x02\x11Tzero::V1::Commonb\x06proto3"
...
var file_common_payment_method_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_common_payment_method_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
func file_common_payment_method_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_common_payment_method_proto_enumTypes,
